...
| MiSS | 相对lora更高效、节省资源 | 计算成本仍然较高 | State Tuning已足够满足需求 |
| 全量微调 | 拟合彻底 | 计算成本最高 | 对于当前项目不值得 |

### 2.3 数据集选择

| 数据集名称 | 特点 | 规模 | 来源 |
|-----------|------|------|------|
| NekoQA-10K | 高质量风格化语言对话数据 | 10.1k rows | https://huggingface.co/datasets/liumindmind/NekoQA-10K |
...
3. **下载RWKV基础模型**：
   参考[这里](https://www.rwkv.cn/tutorials/basic/Model-Download)下载`rwkv7-g1b-1.5b-20251202-ctx8192.pth`，并将其放入`models/`目录下。
...
**项目地址**：https://gitee.com/Lynlane/neko-chat-rwkv/
